...
<div style="display: flex; justify-content: space-between; align-items: flex-start; gap: 40px; margin-top: 40px;">
  ...
  exploring how Foundation AI Models (e.g., Large Language Models) can support end-to-end engineering design creation.</p>

  <p>I co-founded <a href="https://pitchbook.com/profiles/company/490702-69#overview" target="_blank">DigiCodon</a>, 
  where I served as CTO, building <a href="https://en.wikipedia.org/wiki/DNA_digital_data_storage" target="_blank">DNA digital data storage</a> technologies.</p>
